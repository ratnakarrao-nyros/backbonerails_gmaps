...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { end: @visitor.end, name: @visitor.name, place: @visitor.place, start: @visitor.start }
    end
  ...
  test "should update visitor" do
    put :update, id: @visitor, visitor: { end: @visitor.end, name: @visitor.name, place: @visitor.place, start: @visitor.start }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
